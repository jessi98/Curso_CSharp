namespace Vetor
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double[] reais = { 4.5, 3.2, 7.85, 10.64, 2.1, -9.08};

            
            //Trabalhar com vetor sempre usar o simbolo de menor '<'
            ...
            */
            ...
            Console.WriteLine("O último nome em ordem alfabetica é: " + nomes_maior);
        }
